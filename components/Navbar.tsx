...
const Navbar: React.FC<NavbarProps> = ({ activeView, setActiveView }) => {
  ...
  return (
    <nav className="bg-blue-900 text-white shadow-2xl sticky top-0 z-50 no-print border-b-2 border-black">
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center h-16">
          <div className="flex items-center space-x-2">
            <div className="bg-green-700 p-1.5 rounded-lg border border-black shadow-inner">
