  ...
  return (
    <div className="space-y-6 pb-20">
      <div className="flex justify-between items-center no-print bg-white p-4 rounded-xl shadow-sm border border-gray-100">
        ...
        <div className="flex space-x-3">
          ...
          <button 
            ...
            className="flex items-center space-x-2 bg-emerald-700 text-white px-6 py-2.5 rounded-lg hover:bg-emerald-800 transition-colors shadow-lg font-bold"
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="flex justify-center bg-gray-200 py-8 print:p-0 print:bg-white min-h-screen">
        ...
        >
          {/* Header */}
          <div className="border-b-4 border-emerald-800 pb-4 mb-6 text-center avoid-break relative">
            <div className="flex justify-between items-center mb-2">
               <div className="flex flex-col items-start border-r border-emerald-100 pr-4">
                  <span className="text-[10px] font-black text-emerald-800 uppercase tracking-tighter">Accreditation</span>
                  <span className="text-[8px] font-bold text-gray-400">Cert No: 910223</span>
               </div>
               <div className="flex-1 px-4">
                  <h1 className="text-xl font-black text-emerald-800 leading-tight uppercase tracking-tight">{LAB_NAME}</h1>
                  <p className="text-sm font-bold text-gray-700">{LAB_LOCATION}</p>
               </div>
               <div className="flex flex-col items-end border-l border-emerald-100 pl-4">
                  <span className="text-[10px] font-black text-emerald-800 uppercase tracking-tighter">Standard</span>
            ...
            <div className="flex justify-center space-x-4 mt-4">
              <div className="flex flex-col items-center">
                <div className="bg-emerald-800 text-white text-[9px] font-black px-4 py-1 rounded shadow-sm border border-emerald-900">
                  {ISO_CERT}
                </div>
              </div>
              <div className="flex flex-col items-center">
                <div className="bg-white text-emerald-800 text-[9px] font-black px-4 py-1 rounded shadow-sm border border-emerald-800">
                  {NABL_CERT}
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-2 gap-y-3 gap-x-10 text-[12px] mb-6 border border-gray-100 p-4 rounded-lg bg-gray-50/30 avoid-break">
            ...
            <div className="flex">
              ...
              <span className="font-mono text-emerald-700 font-bold">CADDL/AGD/{report.id.slice(0, 6).toUpperCase()}</span>
            </div>
            ...
            <div className="flex">
              ...
              <span className="text-emerald-800 font-black">{report.dateOfReport}</span>
            </div>
          </div>

          {/* Executive Summary */}
          {report.conciseSummary && (
            <div className="mb-6 px-4 py-3 bg-emerald-50 border-l-4 border-emerald-800 rounded-r-lg avoid-break">
              <div className="flex items-center mb-1">
                <svg className="w-3 h-3 text-emerald-800 mr-2" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clipRule="evenodd"></path></svg>
                <h3 className="text-[10px] font-black text-emerald-900 uppercase tracking-widest">Executive Clinical Summary</h3>
              </div>
              <p className="text-[12px] font-bold text-emerald-950 italic leading-tight">
                {report.conciseSummary}
              </p>
            </div>
          )}
          ...
          <div className="mb-8 flex-grow">
            <h2 className="text-center font-black text-white bg-emerald-800 py-1.5 mb-2 uppercase tracking-[0.1em] text-[10px] rounded-t avoid-break">DIAGNOSTIC TEST RESULTS</h2>
                ...
                {Object.entries(report.categorizedResults).map(([catKey, tests]) => {
                  ...
                  return (
                    <React.Fragment key={catKey}>
                      <tr className="bg-emerald-50/50 avoid-break">
                        <td colSpan={4} className="border border-gray-200 px-4 py-1.5 font-black text-emerald-900 text-[10px] tracking-widest bg-emerald-100/50 uppercase">
          ...
          <div className="mb-10 avoid-break">
            <div className="flex items-center space-x-2 mb-2">
              <div className="h-3 w-1 bg-emerald-800"></div>
              <h3 className="font-black text-emerald-900 text-[10px] uppercase tracking-wider">Comprehensive Pathologist Review & Recommendations</h3>
            </div>
          ...
          <div className="mt-auto flex justify-between items-end px-10 mb-10 avoid-break">
            ...
            <div className="text-center">
               <div className="w-64 border-t border-gray-900 pt-2">
                ...
                <p className="text-[9px] text-emerald-800 font-bold uppercase tracking-tighter">Diagnostic Laboratory, Allagadda</p>
              </div>
            </div>
          </div>
