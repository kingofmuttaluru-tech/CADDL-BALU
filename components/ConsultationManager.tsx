...
const ConsultationManager: React.FC<ConsultationManagerProps> = ({ 
  ...
  return (
    <div className="space-y-6 animate-fadeIn">
      <div className="flex justify-between items-center">
        ...
        {!showForm && (
          <button 
            ...
            className="bg-emerald-800 text-white px-6 py-2 rounded-lg font-bold hover:bg-emerald-900 transition-all shadow-md flex items-center space-x-2"
          >
      ...
      {showForm ? (
        <form onSubmit={handleSubmit} className="bg-white p-8 rounded-xl shadow-lg border border-emerald-100 space-y-6 animate-fadeIn">
          <div className="flex justify-between items-center mb-4">
            <h3 className="font-bold text-emerald-800 uppercase text-xs tracking-widest">Consultation Details</h3>
          ...
          <div className="flex justify-end space-x-3 pt-4">
            ...
            <button 
              type="submit"
              className="px-10 py-2.5 bg-emerald-800 text-white rounded-lg font-bold hover:bg-emerald-900 transition-all shadow-lg"
            >
        ...
        <div className="bg-white rounded-xl shadow-md border border-gray-100 overflow-hidden">
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead>
                <tr className="bg-emerald-50/50 text-left text-[10px] text-emerald-800 uppercase font-black tracking-widest">
